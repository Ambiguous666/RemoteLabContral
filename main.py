...
class modbus:
            ...
            if count > 0:
                ...
                if data != b'':
                    ...
                    if self.__checkSum(self, data) is True:
                        ...
                        print(self.__stateV, 'TCV:', self.__tempCV, 'TSV:', self.__tempSV, ' ', self.__humiCV, ' ', self.__humiSV, '', self.__satempCV, '', self.__satempCV)
                        #print('校验成功')
                    else:
                        print('校验失败')
    ...
    def temi_set_temp(self, flaot):
        """修改定值温度设定值"""
        cmd1 = b'E01#62#01#02' % (flaot)   #格式：E01#60#01#02修改值#A    例如:E01#600#478#56.24#A 把温度的设定值改为56.24
